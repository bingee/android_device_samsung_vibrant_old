...
mkdir -p ../../../vendor/samsung/vibrant

(cat << EOF) | sed s/__DEVICE__/vibrant/g > ../../../vendor/samsung/vibrant/vibrant-vendor.mk
# Copyright (C) 2010 The Android Open Source Project
#
# Licensed under the Apache License, Version 2.0 (the "License");
# you may not use this file except in compliance with the License.
...
(cat << EOF) | sed s/__DEVICE__/vibrant/g > ../../../vendor/samsung/vibrant/BoardConfigVendor.mk
# Copyright (C) 2010 The Android Open Source Project
#
# Licensed under the Apache License, Version 2.0 (the "License");
# you may not use this file except in compliance with the License.
...
(cat << EOF) | sed s/__DEVICE__/vibrant/g > ../../../vendor/samsung/vibrant/overlay/packages/apps/Launcher2/res/layout/all_apps.xml
